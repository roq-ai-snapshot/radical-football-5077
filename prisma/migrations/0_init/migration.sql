...
-- AddForeignKey
ALTER TABLE "player_performance" ADD CONSTRAINT "player_performance_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
